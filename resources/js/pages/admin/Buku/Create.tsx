...
export default function BukuCreate() {
    ...
    const [chapters, setChapters] = useState([
        { title: '', content: '', coin_price: '', doc_file: null as File | null, isExpanded: true }
    ]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Append chapters and individual chapter Word/Text files
        const cleanChapters = chapters
            ...
            .filter(c => c.title || c.content || c.has_doc);
    ...
    return (
        <div className="flex h-screen bg-[#f8fafc] font-sans overflow-hidden">
            <Head title="Tambah Buku - BookStore" />
                ...
                <div className="p-8 w-full space-y-8">
                    ...
                    <header className="flex justify-between items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900">Tambah Buku Baru</h2>
                                <p className="text-gray-500 text-sm mt-1">Lengkapi informasi di bawah untuk menambahkan buku.</p>
                            </div>
                        </div>
                    </header>
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl shadow-sm mt-8 overflow-hidden">
                                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">Tambahkan bab sebanyak yang Anda inginkan saat membuat buku ini.</p>
                                    </div>
                                    <button 
                                        type="button"
                                                        ...
                                                        {chapter.doc_file ? (
                                                                ...
                                                                <div className="flex items-center gap-3 min-w-0">
                                                                    ...
                                                                    <div className="truncate">
                                                                        ...
                                                                        <p className="text-xs text-gray-500">
                                                                            {(chapter.doc_file.size / 1024).toFixed(1)} KB • Dokumen siap diproses
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <button
                                                            ...
                                                            <label className="flex flex-col items-center justify-center p-3.5 border-2 border-dashed border-gray-200 hover:border-blue-400 rounded-xl cursor-pointer bg-gray-50/50 hover:bg-blue-50/30 transition-all group">
                                                                <div className="flex items-center gap-2 text-gray-500 group-hover:text-blue-600">
                                                                    <Upload size={16} />
                                                                    <span className="text-xs font-medium">Pilih file Word (.docx) atau Teks (.txt)</span>
                                                                </div>
