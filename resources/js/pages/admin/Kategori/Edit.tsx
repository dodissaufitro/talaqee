...
export default function KategoriEdit() {
    const { category, icons, errors, auth } = usePage<PageProps>().props;
                ...
                <div className="p-8 w-full space-y-8">
                    ...
                    <header className="flex justify-between items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900">Edit Kategori</h2>
                                <p className="text-gray-500 text-sm mt-1">Perbarui informasi kategori di bawah ini.</p>
                            </div>
                        </div>
                    </header>
