        ...
        <>
            ...
            <div className="block md:hidden min-h-screen font-sans bg-gradient-to-b from-[#F0F5FF] to-white pb-10">
                ...
                <div className="bg-white rounded-[24px] p-6 mx-5 shadow-sm border border-[#F1F5F9] relative z-10">
                    ...
                    <div className="mb-6">
                        <a href="/auth/google" className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors">
                ...
                <div className="max-w-md w-full mx-auto bg-white lg:border lg:border-gray-100 lg:shadow-xl lg:rounded-3xl lg:p-10">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="mt-6 grid grid-cols-3 gap-3">
                            <a href="/auth/google" className="flex justify-center items-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
